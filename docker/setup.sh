...
echo ""
echo "  2. Build an FPGA project:"
echo -e "     ${YELLOW}build-fpga.sh path/to/project.qpf --rbf${NC}"
echo ""
echo "  3. Cross-compile HPS code:"
echo -e "     ${YELLOW}build-hps.sh path/to/hps/directory${NC}"
echo ""
echo "  4. When done, stop the container:"
echo -e "     ${YELLOW}docker compose down${NC}"
echo ""
echo -e "See ${BLUE}docker/README.md${NC} for detailed documentation."
