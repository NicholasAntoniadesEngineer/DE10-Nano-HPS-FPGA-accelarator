...
const test_case_t test_cases[] = {
    ...
    // ========================================================================
    // IEEE 754 Edge Cases (expect hardware error flag)
    // ========================================================================
    {CALC_OP_DIV, 1.0f, 0.0f, 0.0f, "Division by zero: 1.0 / 0.0", true},
    {CALC_OP_MUL, 1.0e38f, 10.0f, 0.0f, "Overflow: 1e38 * 10", true},
    {CALC_OP_DIV, 1.0e-38f, 1.0e10f, 0.0f, "Underflow: 1e-38 / 1e10", true},
};
