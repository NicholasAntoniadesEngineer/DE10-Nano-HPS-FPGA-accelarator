...
module calculator (
    ...
    input  wire [5:0]  avs_s0_address,     // 6 bits (64 bytes, 16 registers)
...
// Individual error flags (core -> registers for ERROR_CODE)
wire        calc_error_overflow;
wire        calc_error_underflow;
wire        calc_error_nan;
wire        calc_error_div_zero;
wire        calc_error_watchdog;
...
calculator_registers register_file (
    ...
    .calc_error_overflow  (calc_error_overflow),
    .calc_error_underflow (calc_error_underflow),
    .calc_error_nan       (calc_error_nan),
    .calc_error_div_zero  (calc_error_div_zero),
    .calc_error_watchdog  (calc_error_watchdog),
...
calculator_core core (
    ...
    // Individual error flags
    .error_overflow    (calc_error_overflow),
    .error_underflow   (calc_error_underflow),
    .error_nan         (calc_error_nan),
    .error_div_zero    (calc_error_div_zero),
    .error_watchdog    (calc_error_watchdog)
);
...
// Price buffer is wired to register file but has no HPS driver (future work)
