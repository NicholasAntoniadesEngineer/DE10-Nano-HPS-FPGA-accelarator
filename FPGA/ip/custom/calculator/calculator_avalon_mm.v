...
// Address Decoding
// ============================================================================
// avs_s0 is configured with addressUnits=WORDS in _hw.tcl, so the QSys
// interconnect translator (AV_ADDRESS_SYMBOLS=0) presents a word-index
// directly on avs_address — each increment of 1 = one 32-bit register.
// Use the lower 4 bits directly as the register index (0-15).
assign reg_address = avs_address[3:0];
